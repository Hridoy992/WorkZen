...
export const EntryPage = () => {
    const handleHRAdminClick = () => {
        // Clear logout flag when user wants to login again
        ...
        <div className="extry-page-container h-[100vh] flex justify-center items-center">
            <div className="entry-page-content">
                ...
                <div className="buttons flex justify-center placeholder:items-center gap-5">
                    ...
                    <Link to={"/auth/HR/login"} onClick={handleHRAdminClick}><Button className="bg-purple-600 text-white font-bold text-lg">HR-Admin</Button> </Link>
                </div>
            </div>
        </div >
    )
