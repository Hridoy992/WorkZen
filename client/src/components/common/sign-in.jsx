...
export const SignIn = ({ image, handlesigninform, handlesigninsubmit, targetedstate, statevalue, redirectpath, signupPath }) => {
    return (
        <>
                        ...
                        {signupPath && (
                            <div className="text-center">
                                <p className="text-sm text-gray-600">
                                    ...
                                    <Link to={signupPath} className="font-semibold text-indigo-600 hover:text-indigo-500">
                                        Sign up here
                                    </Link>
                                </p>
                            </div>
